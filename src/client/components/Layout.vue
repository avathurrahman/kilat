...
<template>
	<div class="grid grid-cols-[260px_1fr] min-h-screen bg-bg max-md:grid-cols-1">
		...
		>
			...
			<div class="p-3 border-t border-border">
				<div class="p-3.5 rounded-[10px] bg-bg border border-border">
					<p class="m-0 text-sm font-bold">Kilat</p>
					<p class="mt-0.5 text-xs text-muted">Workers · D1 · Inertia v3</p>
				</div>
			</div>
		</aside>
		...
		<div class="flex flex-col min-w-0">
			...
			>
				<span>Kilat boilerplate</span>
				<span>Workers · Hono · D1 · Inertia v3</span>
			</footer>
		</div>
	</div>
</template>
