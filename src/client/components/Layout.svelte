...
<div class="dash">
  ...
  >
    ...
    <div class="sidebar-foot">
      <div class="sidebar-foot-card">
        <p class="sidebar-foot-title">Kilat</p>
        <p class="sidebar-foot-sub">Workers · D1 · Inertia v3</p>
      </div>
    </div>
  </aside>
  ...
  <div class="dash-main">
    ...
    <footer class="footer">
      <span>Kilat starter</span>
      <span class="footer-stack">Workers · Hono · D1 · Inertia v3</span>
    </footer>
  </div>
</div>
...
<style>
  ...
  .sidebar :global(.sidebar-link:hover) {
    text-decoration: none;
    background: var(--primary-soft);
    color: var(--text);
  }

  .sidebar :global(.sidebar-link-active) {
    background: var(--primary-soft);
    color: var(--primary);
    font-weight: 600;
  }
  ...
  :global(.sidebar-link-active) .sidebar-link-icon {
    color: var(--primary);
  }
  ...
  .user-menu :global(.user-menu-item) {
    display: flex;
    align-items: center;
    gap: 0.55rem;
    width: 100%;
  ...
  .user-menu :global(.user-menu-item:hover) {
    text-decoration: none;
    background: var(--primary-soft);
  }
